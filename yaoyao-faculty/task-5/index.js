...
(function () {  
    ...
    function init () {
        ...
        boxPlayGround.x = Math.ceil(Math.random() * 10);
        boxPlayGround.y = Math.ceil(Math.random() * 10);
        // render UI
        ...
        const execCommand = () => {
            ...
            try {
                ...
                switch (cmd[0].toUpperCase()) {
                    ...
                    case 'TRA'      :
                    case 'TRANSFER' : boxPlayGround.transfer(cmd[1]); break;
                    
                    case 'MOV'      :
                    case 'MOVE'     : boxPlayGround.move(cmd[1]); break;  
